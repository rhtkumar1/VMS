        ...
        public  IEnumerable<Menu_Master_Display> GetMinu(int UserID,out List<Menu_Master_Role_Wise> ObjMenu_Master_Role_Wise)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr0 in dt.Rows)
                {
                    ...
                    objMenu_Master_Role_Wise.AppToken = string.Format("MID={0};AuthMode={1}", objMenu_Master_Role_Wise.MenuID.ToString(), objMenu_Master_Role_Wise.AuthMode.ToString());//Uri.EscapeDataString(EncryptDecrypt.EncryptString(string.Format("MID={0};AuthMode={1}", objMenu_Master_Role_Wise.MenuID.ToString(), dr0["Auth"].ToString())));
                ...
                foreach (DataRow dr0 in dt.Rows)
                {
                    if (CommonUtility.ConvertInt(dr0["menu_parent_id"]) == 0)
                    {
                        ...
                        Minu0.AppToken = string.Format("MID={0};AuthMode={1}", Minu0.MenuID.ToString(), dr0["Auth"].ToString());//Uri.EscapeDataString(EncryptDecrypt.EncryptString(string.Format("MID={0};AuthMode={1}", Minu0.MenuID.ToString(), dr0["Auth"].ToString())));
                       // 1 Lable
                        foreach (DataRow dr1 in dt.Rows)
                        {
                            if (Minu0.MenuID == (CommonUtility.ConvertInt(dr1["menu_parent_id"])))
                            {
                                ...
                                Minu1.AppToken = string.Format("MID={0};AuthMode={1}", Minu1.MenuID.ToString(), dr1["Auth"].ToString());//Uri.EscapeDataString(EncryptDecrypt.EncryptString(string.Format("MID={0};AuthMode={1}", Minu1.MenuID.ToString(), dr1["Auth"].ToString())));
                                ...
                                foreach (DataRow dr2 in dt.Rows)
                                {
                                    if (Minu1.MenuID == (CommonUtility.ConvertInt(dr2["menu_parent_id"])))
                                    {
                                        ...
                                        Minu2.AppToken = string.Format("MID={0};AuthMode={1}", Minu2.MenuID.ToString(), dr2["Auth"].ToString());//Uri.EscapeDataString(EncryptDecrypt.EncryptString(string.Format("MID={0};AuthMode={1}", Minu2.MenuID.ToString(), dr2["Auth"].ToString())));
                                        ...
                                        foreach (DataRow dr3 in dt.Rows)
                                        {
                                            if (Minu2.MenuID == (CommonUtility.ConvertInt(dr3["menu_parent_id"])))
                                            {
                                                ...
                                                Minu3.AppToken = string.Format("MID={0};AuthMode={1}", Minu3.MenuID.ToString(), dr3["Auth"].ToString());//Uri.EscapeDataString(EncryptDecrypt.EncryptString(string.Format("MID={0};AuthMode={1}", Minu3.MenuID.ToString(), dr3["Auth"].ToString())));
