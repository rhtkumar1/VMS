...
function BindGrid(result, isqtydisabled, sourceid) {
    ...
    $.each(result, function (index, value) {
        ...
        let lblItem = `<label id="lblItem_${value.GR_Id}">${value.GR_Id}</label>
                            <input type="hidden" id="hdnItemId_${value.GR_Id}" name="hdnItemId_${value.GR_Id}" value="${value.GR_Id}" />
                            <input type="hidden" id="hdnLineId_${value.GR_Id}" name="hdnLineId_${value.GR_Id}" value="${value.GR_Id === undefined ? "0" : value.GR_Id}" />
